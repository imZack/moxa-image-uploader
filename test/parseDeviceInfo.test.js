...
describe('parseDeviceInfo', () => {
  ...
  it('should capture UC-3100 Boot Loader 1.4.0S01', () => {
    parseDeviceInfo(result)(fs.readFileSync(`${__dirname}/fixtures/3100/1.4.0S01.telnet`));

    expect(result).to.have.property('modelName', 'UC-3121-T-US-LX');
    expect(result).to.have.property('bootloaderVersion', '1.4.0S01');
    expect(result).to.have.property('cpuType', '1000MHz');
    expect(result).to.have.property('bootloaderBuildDate', 'Aug 27 2019 - 13:13:39');
